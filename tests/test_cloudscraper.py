...
class TestCloudScraper:
    ...
    @mockCloudflare(
        ...
        payload=OrderedDict(
            [
                ...
                (
                    "r",
                    "b7f071b2f22b5dfecd144198317929d3f7c8d3d271c169e7676a42042c3581ed",
                ),
            ]
        ),
    )
    ...
    @mockCloudflare(
        ...
        payload=OrderedDict(
            [
                ...
                (
                    "r",
                    "f111bf7fe2d4d39d47dd837590808eeacb6e208a7503587f14a95c9ab0fc2d70",
                ),
            ]
        ),
    )
    ...
    @mockCloudflare(
        ...
        payload=OrderedDict(
            [
                ...
                (
                    "r",
                    "af028b8967c508037f3888dfaf85d403df9532f4ad851fea76c2ece4f4d9853b",
                ),
            ]
        ),
    )
    ...
    def test_bad_solve_js_challenge1_16_05_2020(self, **kwargs):
        ...
        with pytest.raises(CloudflareLoopProtection, match=r".*?Loop Protection.*?"):
    ...
    def test_Captcha_challenge_12_12_2019(self, **kwargs):
        ...
        with pytest.raises(CloudflareCaptchaProvider, match=r".*?Captcha detected*?"):
            scraper = cloudscraper.create_scraper(**kwargs)
            scraper.get(url)
    ...
    def test_user_agent(self, **kwargs):
        ...
        with pytest.raises(
            ...
            scraper = cloudscraper.create_scraper(
                browser={"browser": "chrome", "desktop": False, "mobile": False},
                delay=0.1,
            )
